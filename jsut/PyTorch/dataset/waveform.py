...
class JSUT_wave(Dataset): # I failed to understand this error
    ...
    def __init__(
        ...
        Args:
            ...
            dataset_dir_adress: URL/localPath of JSUT_wave dataset directory (e.g. `s3::` can be used). None use default local path.
        ...
        self._path_contents_local = JSUT_wave_root/"contents"/arg_hash
        dataset_dir_adress = dataset_dir_adress if dataset_dir_adress else str(JSUT_wave_root/"archive")
